...
public class ScrollBarUI extends BasicScrollBarUI {
	...
	protected void configureScrollBarColors() {
		...
		// trackColor = new Color(204, 204, 204); // 滑道
	}
	...
	protected void paintTrack(Graphics g, JComponent c, Rectangle trackBounds) {
		...
		g.setColor(new Color(204, 204, 204)); // 设置滑道颜色
	}
	...
	protected void paintThumb(Graphics g, JComponent c, Rectangle thumbBounds) {
		...
		g.drawRoundRect(2, 0, thumbBounds.width - 4, thumbBounds.height - 1, 11, 11); 
		// 消除锯齿
		...
		// 填充圆角矩形
		g2.fillRoundRect(3, 0, thumbBounds.width - 4, thumbBounds.height - 1, 9, 9);
	}
