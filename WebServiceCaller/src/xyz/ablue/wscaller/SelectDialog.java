...
public class SelectDialog extends JDialog {
	...
	void btnOK_actionPerformed(ActionEvent e) {
		...
		if (result == null) {
			JOptionPane.showMessageDialog(this, "尚未选择相关项目！", "提示信息", JOptionPane.WARNING_MESSAGE);
		} else {
			dispose();
		}
	}
...
class SelectDialog_btnOK_actionAdapter implements java.awt.event.ActionListener {
...
class SelectDialog_btnCancel_actionAdapter implements java.awt.event.ActionListener {
	SelectDialog adaptee;
